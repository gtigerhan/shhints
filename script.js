...
class EscapeRoomTimer {
    ...
    setupEventListeners() {
        ...
        // Triple tap on timer area to show admin panel (only when admin panel is hidden)
        this.timerSection.addEventListener('click', (e) => {
            if (!this.adminPanel.classList.contains('show')) {
                this.handleTripleTap();
            }
        });
        
        this.timerSection.addEventListener('touchend', (e) => {
            if (!this.adminPanel.classList.contains('show')) {
                e.preventDefault();
                this.handleTripleTap();
            }
